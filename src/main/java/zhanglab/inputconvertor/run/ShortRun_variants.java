...
public class ShortRun_variants {
	...
	public static void main(String[] args) throws IOException, ParseException {
		...
		refGenomeFile = new File("/Users/seunghyukchoi/Documents/_resources/_databases/GRCm38.primary_assembly.genome.fa");
		refGTFFile = new File("/Users/seunghyukchoi/Documents/_resources/_databases/gencode.vM23.basic.annotation.gtf");
		varFile = new File("/Volumes/Papers/2025_T11/1.Exome_alignment/mutect2+strelka2.pass.vcf");
		outputFile = new File("/Volumes/Papers/2025_T11/variants.fasta");
		uniqueId = "";
        ...
        for(FastaEntry entry : entries) {
        	// only write mutated sequences
        	if(entry.mutationMark != null) {
